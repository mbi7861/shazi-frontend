...
const ProductView = ({ initialProduct }) => {
  ...
  return (
    <>
      ...
      <div className="px-6 md:px-16 lg:px-32 mt-14 space-y-10">
        {/* Breadcrumbs */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <ProductGallery
            ...
            primaryImage={
              currentItem?.primary_image || productData.primary_image
            }
          />

          <div className="flex flex-col">
            <h1 className="text-3xl font-medium shazi-black mb-4">
              {productData.title}
            </h1>
            ...
            <div
              className="shazi-black/80 mt-3 overflow-auto"
