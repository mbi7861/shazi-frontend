...
import { getVariationStructure } from "@/lib/product/getVariationStructure";
...
const ProductView = ({ initialProduct, relatedProducts }) => {
    ...
    const variations = getVariationStructure(productItems);

    // Get initial selected options from default item
