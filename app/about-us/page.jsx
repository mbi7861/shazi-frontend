...
export default function AboutUs() {
  return (
    <>
      ...
      <div className="px-6 md:px-16 lg:px-32 py-16 text-white">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            About <span className="text-shazi-gold">Us</span>
          </h1>
          ...
          <div className="space-y-8 ">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-medium mb-2">Circuit Breakers</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-medium mb-2">Lighting Solutions</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-medium mb-2">Heaters</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-medium mb-2">Other Home Electronics</h3>
                  <p>
            ...
            <section>
              ...
              <div className="bg-primary-light p-4 rounded-lg">
                ...
                <p className="mt-4 text-sm">
                  Visit our <Link href="/contact-us" className="text-shazi-gold hover:underline"> Contact Us </Link> page to send us a message.
                </p>
              </div>
            </section>

            <section className="bg-primary-light p-6 rounded-lg border-l-4 border-shazi-gold">
              <p className="text-lg font-semibold text-shazi-gold mb-2">
