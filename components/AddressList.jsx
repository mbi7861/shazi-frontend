...
export default function AddressList({ prevAddressId, onSelect }) {
    ...
    // -----------------------------
    return (
        <div className=" rounded-lg border border-white shadow-md p-6 mb-6">
            {/* Header */}
            <div className="flex justify-between items-center mb-4">
                {addresses.length >= MAX_ADDRESSES && (
                    <p className="text-sm">Maximum 5 addresses. Delete one to add another.</p>
                )}
                <div className="ml-auto">
                    {addresses.length < MAX_ADDRESSES && (
                        <button
                            ...
                            className="bg-shazi-gold text-white px-4 py-2 rounded flex items-center gap-2 hover:bg-shazi-gold/80"
                        >
                            <Plus size={18} />
                            Add New
                        </button>
            ...
            {/* No Address */}
            {addresses.length === 0 && (
                <p className=" text-center">No saved addresses. Add one.</p>
            )}
